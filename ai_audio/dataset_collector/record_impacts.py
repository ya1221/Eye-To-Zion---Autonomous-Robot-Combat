...
def parse_args():
    ...
    p.add_argument("--pre-roll", type=float, default=0.2, help="seconds kept before a trigger (trigger mode)")
    p.add_argument("--post-roll", type=float, default=0.8, help="seconds kept after a trigger (trigger mode)")
