...
## Logic
Processes incoming video frames using a YOLO-based computer vision model to create bounding boxes and determine the relative position of enemies or objectives.
